软件支持Windows跟Linux，小白请无脑使用Windows版[Windows版下载点我](https://raw.githubusercontent.com/Char1es0rz/minerProxy/3.0.3-web版/minerProxy_web.exe)，[Windows守护进程工具下载](https://wwe.lanzouj.com/i1uRazox1le)，中转数据混淆加密，绝对安全。防止被查水表。
=================
开发费(纯转发模式没有开发费）
===============
